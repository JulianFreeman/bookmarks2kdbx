  ...
  <div class="container">
    ...
    <div class="card">
      <div class="controls">
        ...
        <div class="password">
          <input :type="showPassword ? 'text' : 'password'" class="input" placeholder="设置 KDBX 密码（可选）" v-model="password" />
          <button class="btn eye-btn" @click="showPassword = !showPassword" :title="showPassword ? '隐藏密码' : '显示密码'">
            {{ showPassword ? '👁️' : '👁️‍🗨️' }}
          </button>
        </div>
      </div>
